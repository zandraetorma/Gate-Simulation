			...
			if (isElementPresent(findTestObject('Object Repository/Gate Simulation/CY Gate by Appointment/proceed_in_gate_button'), 120))
					{
						...
						while (Global.outgateThreadCounter >= Global.outgateThreadLimit){
							println ("Sleeping for 10 seconds, active thread count is >= outgateThreadLimit. outgateThreadCounter: " + Global.activeThreadCount + "; outgateThreadLimit: "+ Global.outgateThreadLimit);
							Thread.sleep(10000)
						}
...
//		}
	...
	// Open browser if log file is found
		...
		if (laneType == "IN")
			...
			WebUI.delay(5)
			//Thread.sleep(10000);
			if (isElementPresent(findTestObject('Object Repository/Gate Simulation/CY Gate by Appointment/proceed_button'), 120))
			{
				WebUI.click(findTestObject('Object Repository/Gate Simulation/CY Gate by Appointment/proceed_button'))
